...
import static common.constants.SystemConstants.JASPER_TEMPLATE_PATH;
import static common.enums.FileTypeConstant.JASPER;
...
public abstract class BaseCRUDController extends CRUD {
    ...
    protected static InputStream getJasperFileInputStream(final String jasperFile) {
